...
#
#
#   $Id: Font.pm,v 1.3 2003/12/08 13:05:22 Administrator Exp $
#
#=======================================================================
...
defaults to L<PDF::API2::Basic::TTF::Table>. The current tables which are supported are:
...
L<PDF::API2::Basic::TTF::Table> L<PDF::API2::Basic::TTF::GDEF> L<PDF::API2::Basic::TTF::GPOS> L<PDF::API2::Basic::TTF::GSUB> L<PDF::API2::Basic::TTF::LTSH>
L<PDF::API2::Basic::TTF::OS_2> L<PDF::API2::Basic::TTF::PCLT> L<PDF::API2::Basic::TTF::Bsln> L<PDF::API2::Basic::TTF::Cmap> L<PDF::API2::Basic::TTF::Cvt_>
L<PDF::API2::Basic::TTF::Fdsc> L<PDF::API2::Basic::TTF::Feat> L<PDF::API2::Basic::TTF::Fmtx> L<PDF::API2::Basic::TTF::Fpgm> L<PDF::API2::Basic::TTF::Glyf>
L<PDF::API2::Basic::TTF::Hdmx> L<PDF::API2::Basic::TTF::Head> L<PDF::API2::Basic::TTF::Hhea> L<PDF::API2::Basic::TTF::Hmtx> L<PDF::API2::Basic::TTF::Kern>
L<PDF::API2::Basic::TTF::Loca> L<PDF::API2::Basic::TTF::Maxp> L<PDF::API2::Basic::TTF::Mort> L<PDF::API2::Basic::TTF::Name> L<PDF::API2::Basic::TTF::Post>
L<PDF::API2::Basic::TTF::Prep> L<PDF::API2::Basic::TTF::Prop> L<PDF::API2::Basic::TTF::Vhea> L<PDF::API2::Basic::TTF::Vmtx> L<PDF::API2::Basic::TTF::OldCmap>
L<PDF::API2::Basic::TTF::Glyph> L<PDF::API2::Basic::TTF::AATKern> L<PDF::API2::Basic::TTF::OldMort>
...
# $VERSION = 0.28;    # MJPH      13-MAR-2002     update ttfbuilder, add PDF::API2::Basic::TTF::Cmap::ms_enc()
...
# $VERSION = 0.03;    # MJPH       9-MAR-1999     Move to PDF::API2::Basic::TTF for CPAN
# $VERSION = 0.02;    # MJPH      12-FEB-1999     Add support for ' nocsum' for DSIGS
# $VERSION = 0.0001;

%tables = (
        'table' => 'PDF::API2::Basic::TTF::Table',
        'GDEF' => 'PDF::API2::Basic::TTF::GDEF',
        'GPOS' => 'PDF::API2::Basic::TTF::GPOS',
        'GSUB' => 'PDF::API2::Basic::TTF::GSUB',
        'LTSH' => 'PDF::API2::Basic::TTF::LTSH',
        ...
        'PCLT' => 'PDF::API2::Basic::TTF::PCLT',
        'bsln' => 'PDF::API2::Basic::TTF::Bsln',
        'cmap' => 'PDF::API2::Basic::TTF::Cmap',
        'cvt ' => 'PDF::API2::Basic::TTF::Cvt_',
        'fdsc' => 'PDF::API2::Basic::TTF::Fdsc',
        'feat' => 'PDF::API2::Basic::TTF::Feat',
        'fmtx' => 'PDF::API2::Basic::TTF::Fmtx',
        'fpgm' => 'PDF::API2::Basic::TTF::Fpgm',
        'glyf' => 'PDF::API2::Basic::TTF::Glyf',
        'hdmx' => 'PDF::API2::Basic::TTF::Hdmx',
        'head' => 'PDF::API2::Basic::TTF::Head',
        'hhea' => 'PDF::API2::Basic::TTF::Hhea',
        'hmtx' => 'PDF::API2::Basic::TTF::Hmtx',
        'kern' => 'PDF::API2::Basic::TTF::Kern',
        'loca' => 'PDF::API2::Basic::TTF::Loca',
        'maxp' => 'PDF::API2::Basic::TTF::Maxp',
        'mort' => 'PDF::API2::Basic::TTF::Mort',
        'name' => 'PDF::API2::Basic::TTF::Name',
        'post' => 'PDF::API2::Basic::TTF::Post',
        'prep' => 'PDF::API2::Basic::TTF::Prep',
        'prop' => 'PDF::API2::Basic::TTF::Prop',
...
=head2 PDF::API2::Basic::TTF::Font->AddTable($tablename, $class)
...
=head2 PDF::API2::Basic::TTF::Font->Init
...
=head2 PDF::API2::Basic::TTF::Font->new(%props)
...
=head2 PDF::API2::Basic::TTF::Font->open($fname)
...
sub read
{
    ...
    for ($i = 0; $i < $dir_num; $i++)
    {
        ...
        $type = $tables{$name} || 'PDF::API2::Basic::TTF::Table';
        $t = $type;
        if ($^O eq "MacOS")
        { $t =~ s/^|::/:/oig; }
        else
...
#        $self->{'head'}{'checkSumAdjustment'} = 0;
    ...
    ($numTables, $sRange, $eSel, $shift) = PDF::API2::Basic::TTF::Utils::TTF_bininfo($numTables, 16);
...
the C<PDF::API2::Basic::TTF::Font> object.

B<NOTE>, that it is important that you call this method on any
C<PDF::API2::Basic::TTF::Font> object when you wish to destruct it and free up its memory.
...
able to do anything else with the C<PDF::API2::Basic::TTF::Font> object; it'll have B<no>
internal state whatsoever.

B<Developer note:> As part of the brute-force cleanup done here, this method
will throw a warning message whenever unexpected key values are found within
the C<PDF::API2::Basic::TTF::Font> object.  This is done to help ensure that any unexpected

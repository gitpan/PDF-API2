...
#
#
#   $Id: Loca.pm,v 1.3 2003/12/08 13:05:24 Administrator Exp $
#
#=======================================================================
package PDF::API2::Basic::TTF::Loca;
...
defaults to L<PDF::API2::Basic::TTF::Glyph>.
...
require PDF::API2::Basic::TTF::Glyph;
...
Reads the location table creating glyph objects (L<PDF::API2::Basic::TTF::Glyph>) for each glyph
...
sub read
{
    ...
    for ($i = 0; $i < $numGlyphs; $i++)
    {
        ...
        $self->{'glyphs'}[$i] = ($self->{'glyphtype'} || "PDF::API2::Basic::TTF::Glyph")->new(
                LOC => $last << ($locFmt ? 0 : 1),

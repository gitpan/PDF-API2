...
#
#
#   $Id: Name.pm,v 1.3 2003/12/08 13:05:25 Administrator Exp $
#
#=======================================================================
...
By default, C<$PDF::API2::Basic::TTF::Name::utf8> is set to 1, and strings will be stored as UTF8 wherever

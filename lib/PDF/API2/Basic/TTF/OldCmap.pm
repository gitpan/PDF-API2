...
#
#
#   $Id: OldCmap.pm,v 1.3 2003/12/08 13:05:25 Administrator Exp $
#
#=======================================================================
package PDF::API2::Basic::TTF::OldCmap;
...
is the L<PDF::API2::Basic::TTF::Segarr> which handles the segmented arrays of format 4 tables,
...
important (although L<PDF::API2::Basic::TTF::Segarr> can work quite happily without it).
...
This points to a L<PDF::API2::Basic::TTF::Segarr> which contains the content of the particular
subtable.
...
require PDF::API2::Basic::TTF::Segarr;
...
sub read
{
    ...
    for ($i = 0; $i < $self->{'Num'}; $i++)
    {
        ...
        if ($form == 0)
        {
            $s->{'val'} = PDF::API2::Basic::TTF::Segarr->new;
            $fh->read($dat, 256);

...
#
#
#   $Id: Post.pm,v 1.3 2003/12/08 13:05:25 Administrator Exp $
#
#=======================================================================
package PDF::API2::Basic::TTF::Post;
...
=item $PDF::API2::Basic::TTF::Post::no25

If set tells PDF::API2::Basic::TTF::Post::out to use table type 2 instead of 2.5 in case apps

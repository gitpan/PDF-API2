...
#
#
#   $Id: Table.pm,v 1.3 2003/12/08 13:05:26 Administrator Exp $
#
#=======================================================================
package PDF::API2::Basic::TTF::Table;
...
The L<PDF::API2::Basic::TTF::Font> that table is part of
...
=head2 PDF::API2::Basic::TTF::Table->new(%parms)
...
sub out_xml
{
    ...
    {
        $self->read_dat;
        PDF::API2::Basic::TTF::Utils::XML_hexdump($context, $depth, $self->{' dat'});
    }
    else
    {
        $self->read;
...
C<PDF::API2::Basic::TTF::Table> object; it'll have B<no> internal state whatsoever.

B<Developer note:>  As part of the brute-force cleanup done here, this method
will throw a warning message whenever unexpected key values are found within
the C<PDF::API2::Basic::TTF::Table> object.  This is done to help ensure that any

...
$fonts->{'bankgothic'} = {
	...
	'descender' => -235.00,
	'italicangle' => 0.00,
	'underlineposition' => -170.00,
	'underlinethickness' => 143.00,
	'xheight' => 423.00,
	'flags' => 262176,
	'isfixedpitch' => 0,
	'issymbol' => 0,
	...
	'bbox' => { 
		...
		'Aacute' => [ 34, 0, 737, 740 ],
		'aacute' => [ 30, 0, 635, 647 ],
		'Acircumflex' => [ 34, 0, 737, 740 ],
		'acircumflex' => [ 30, 0, 635, 647 ],
		'acute' => [ 179, 479, 387, 647 ],
		'Adieresis' => [ 34, 0, 737, 706 ],
		'adieresis' => [ 30, 0, 635, 613 ],
		'ae' => [ 16, 0, 843, 423 ],
		'AE' => [ 18, 0, 980, 517 ],
		'Agrave' => [ 34, 0, 737, 740 ],
		'agrave' => [ 30, 0, 635, 647 ],
		'ampersand' => [ 90, 0, 789, 517 ],
		'applelogo' => [ 56, -17, 735, 789 ],
		'approxequal' => [ 87, 130, 748, 466 ],
		'Aring' => [ 34, 0, 737, 800 ],
		'aring' => [ 30, 0, 635, 721 ],
		'asciicircum' => [ 206, 440, 794, 712 ],
		'asciitilde' => [ 87, 221, 748, 376 ],
		'asterisk' => [ 86, 202, 415, 517 ],
		'at' => [ 52, -143, 950, 716 ],
		'atilde' => [ 30, 0, 635, 617 ],
		'Atilde' => [ 34, 0, 737, 709 ],
		'B' => [ 132, 0, 694, 517 ],
		'b' => [ 95, 0, 578, 423 ],
		'backslash' => [ -23, -16, 302, 533 ],
		'bar' => [ 214, -235, 288, 765 ],
		'braceleft' => [ 83, -202, 423, 722 ],
		'braceright' => [ 79, -202, 419, 722 ],
		'bracketleft' => [ 95, -16, 315, 533 ],
		'bracketright' => [ 17, -16, 237, 533 ],
		'breve' => [ 105, 492, 395, 634 ],
		'brokenbar' => [ 214, -170, 288, 700 ],
		'bullet' => [ 150, 228, 439, 517 ],
		'c' => [ 84, 0, 569, 423 ],
		'C' => [ 122, 0, 686, 517 ],
		'Cacute' => [ 122, 0, 686, 740 ],
		'cacute' => [ 84, 0, 569, 647 ],
		'caron' => [ 105, 478, 396, 647 ],
		'ccaron' => [ 84, 0, 569, 647 ],
		'Ccaron' => [ 122, 0, 686, 740 ],
		'Ccedilla' => [ 122, -232, 686, 517 ],
		'ccedilla' => [ 84, -232, 569, 423 ],
		'cedilla' => [ 141, -232, 396, 0 ],
		'cent' => [ 202, -101, 572, 429 ],
		'circumflex' => [ 105, 478, 396, 647 ],
		'colon' => [ 88, 0, 244, 424 ],
		'comma' => [ 84, -132, 243, 155 ],
		'copyright' => [ 58, -4, 777, 715 ],
		'CR' => [ 0, 0, 0, 0 ],
		'currency' => [ 6, 0, 691, 517 ],
		'd' => [ 95, 0, 633, 423 ],
		'D' => [ 132, 0, 759, 517 ],
		'dagger' => [ 71, -105, 429, 517 ],
		'daggerdbl' => [ 71, -100, 429, 517 ],
		'degree' => [ 24, 431, 306, 711 ],
		'dieresis' => [ 118, 501, 383, 613 ],
		'divide' => [ 125, 58, 709, 541 ],
		'dollar' => [ 98, -129, 676, 619 ],
		'dotaccent' => [ 199, 500, 304, 617 ],
		'dotlessi' => [ 95, 0, 197, 423 ],
		'dslash' => [ 13, 0, 633, 423 ],
		'e' => [ 95, 0, 554, 423 ],
		'E' => [ 132, 0, 666, 517 ],
		'eacute' => [ 95, 0, 554, 647 ],
		'Eacute' => [ 132, 0, 666, 740 ],
		'ecircumflex' => [ 95, 0, 554, 647 ],
		'Ecircumflex' => [ 132, 0, 666, 740 ],
		'edieresis' => [ 95, 0, 554, 613 ],
		'Edieresis' => [ 132, 0, 666, 706 ],
		'egrave' => [ 95, 0, 554, 647 ],
		'Egrave' => [ 132, 0, 666, 740 ],
		'eight' => [ 97, 0, 677, 517 ],
		'ellipsis' => [ 89, 0, 912, 155 ],
		'emdash' => [ 0, 231, 1000, 301 ],
		'endash' => [ 0, 231, 500, 301 ],
		'equal' => [ 125, 167, 709, 430 ],
		'eth' => [ 13, 0, 633, 423 ],
		'Eth' => [ 37, 0, 759, 517 ],
		'euro' => [ 6, 0, 691, 517 ],
		'exclam' => [ 113, 0, 269, 517 ],
		'exclamdown' => [ 113, 0, 269, 517 ],
		'F' => [ 132, 0, 654, 517 ],
		'f' => [ 95, 0, 543, 423 ],
		'fi' => [ 95, 0, 747, 423 ],
		'five' => [ 130, -6, 689, 517 ],
		'fl' => [ 95, 0, 1080, 423 ],
		'florin' => [ 95, -127, 669, 624 ],
		'four' => [ 82, -5, 707, 522 ],
		'fraction' => [ -166, -16, 334, 533 ],
		'franc' => [ 132, 0, 1290, 517 ],
		'G' => [ 122, 0, 733, 517 ],
		'g' => [ 84, 0, 610, 423 ],
		'Gbreve' => [ 122, 0, 733, 727 ],
		'gbreve' => [ 84, 0, 610, 634 ],
		'germandbls' => [ 84, 0, 1243, 423 ],
		'grave' => [ 114, 479, 322, 647 ],
		'greater' => [ 129, 31, 705, 566 ],
		'greaterequal' => [ 128, 12, 707, 589 ],
		'guillemotleft' => [ 63, 64, 500, 359 ],
		'guillemotright' => [ 63, 64, 500, 359 ],
		'guilsinglleft' => [ 63, 64, 270, 359 ],
		'guilsinglright' => [ 63, 64, 270, 359 ],
		'H' => [ 132, 0, 749, 517 ],
		'h' => [ 95, 0, 624, 423 ],
		'hungarumlaut' => [ 148, 479, 452, 647 ],
		'hyphen' => [ 48, 215, 281, 318 ],
		'i' => [ 95, 0, 197, 423 ],
		'I' => [ 132, 0, 252, 517 ],
		'Iacute' => [ 121, 0, 329, 740 ],
		'iacute' => [ 75, 0, 283, 647 ],
		'icircumflex' => [ 1, 0, 292, 647 ],
		'Icircumflex' => [ 47, 0, 337, 740 ],
		'idieresis' => [ 14, 0, 279, 613 ],
		'Idieresis' => [ 60, 0, 325, 706 ],
		'Idot' => [ 132, 0, 252, 709 ],
		'Igrave' => [ 56, 0, 264, 740 ],
		'igrave' => [ 10, 0, 218, 647 ],
		'increment' => [ -2, 0, 672, 720 ],
		'infinity' => [ 108, 108, 727, 492 ],
		'integral' => [ 23, -181, 498, 757 ],
		'J' => [ 80, 0, 557, 517 ],
		'j' => [ 56, 0, 465, 423 ],
		'K' => [ 132, 0, 755, 517 ],
		'k' => [ 95, 0, 627, 423 ],
		...
		'l' => [ 95, 0, 530, 423 ],
		'less' => [ 129, 31, 705, 566 ],
		'lessequal' => [ 128, 12, 707, 589 ],
		'logicalnot' => [ 125, 175, 709, 420 ],
		'lozenge' => [ 3, -232, 492, 808 ],
		'lslash' => [ 27, 0, 530, 423 ],
		'Lslash' => [ 55, 0, 640, 517 ],
		'M' => [ 131, 0, 806, 517 ],
		'm' => [ 95, 0, 673, 423 ],
		'middot' => [ 84, 176, 248, 339 ],
		'minus' => [ 125, 265, 709, 334 ],
		'mu1' => [ -55, -208, 521, 523 ],
		'multiply' => [ 144, 22, 697, 576 ],
		'n' => [ 95, 0, 618, 423 ],
		'N' => [ 131, 0, 738, 517 ],
		'nbspace' => [ 0, 0, 0, 0 ],
		'nine' => [ 107, -12, 671, 517 ],
		'notequal' => [ 125, 14, 709, 584 ],
		'Ntilde' => [ 131, 0, 738, 709 ],
		'ntilde' => [ 95, 0, 618, 617 ],
		'null' => [ 0, 0, 0, 0 ],
		'numbersign' => [ 43, -1, 727, 712 ],
		'o' => [ 84, 0, 631, 423 ],
		'O' => [ 122, 0, 757, 517 ],
		'Oacute' => [ 122, 0, 757, 740 ],
		'oacute' => [ 84, 0, 631, 647 ],
		'Ocircumflex' => [ 122, 0, 757, 740 ],
		'ocircumflex' => [ 84, 0, 631, 647 ],
		'Odieresis' => [ 122, 0, 757, 706 ],
		'odieresis' => [ 84, 0, 631, 613 ],
		'OE' => [ 122, 0, 1017, 517 ],
		'oe' => [ 84, 0, 855, 423 ],
		'ogonek' => [ 166, -219, 325, 0 ],
		'Ograve' => [ 122, 0, 757, 740 ],
		'ograve' => [ 84, 0, 631, 647 ],
		'Omega' => [ 39, 0, 727, 738 ],
		'one' => [ 245, 0, 463, 521 ],
		'onehalf' => [ 154, -16, 1075, 533 ],
		'onequarter' => [ 154, -16, 1100, 533 ],
		'onesuperior' => [ 162, 207, 306, 519 ],
		'ordfeminine' => [ 21, 207, 419, 460 ],
		'ordmasculine' => [ 56, 207, 417, 460 ],
		'oslash' => [ 84, -104, 634, 528 ],
		'Oslash' => [ 120, -127, 759, 645 ],
		'otilde' => [ 84, 0, 631, 617 ],
		'Otilde' => [ 122, 0, 757, 709 ],
		'overscore' => [ 116, 521, 385, 593 ],
		'p' => [ 95, 0, 575, 423 ],
		'P' => [ 132, 0, 690, 517 ],
		'paragraph' => [ 33, 0, 468, 723 ],
		'parenleft' => [ 84, -20, 276, 537 ],
		'parenright' => [ 56, -20, 250, 537 ],
		'partialdiff' => [ 51, -12, 470, 647 ],
		'percent' => [ 44, -16, 754, 533 ],
		'period' => [ 88, 0, 244, 155 ],
		'periodcentered' => [ 84, 176, 248, 339 ],
		'perthousand' => [ 44, -16, 1116, 533 ],
		'pi' => [ -15, -7, 584, 523 ],
		'plus' => [ 125, 0, 709, 597 ],
		'plusminus' => [ 125, 15, 709, 583 ],
		'product' => [ 77, -191, 681, 720 ],
		'q' => [ 84, -107, 631, 423 ],
		'Q' => [ 122, -132, 757, 517 ],
		'question' => [ 106, 0, 542, 517 ],
		'questiondown' => [ 106, 0, 542, 517 ],
		'quotedbl' => [ 44, 431, 256, 702 ],
		'quotedblbase' => [ 84, -132, 491, 155 ],
		'quotedblleft' => [ 89, 229, 496, 517 ],
		'quotedblright' => [ 84, 229, 491, 517 ],
		'quoteleft' => [ 89, 229, 248, 517 ],
		'quoteright' => [ 84, 229, 243, 517 ],
		'quotesinglbase' => [ 84, -132, 243, 155 ],
		'quotesingle' => [ 44, 431, 112, 702 ],
		'R' => [ 132, 0, 745, 517 ],
		'r' => [ 95, 0, 619, 423 ],
		'radical' => [ 30, -20, 638, 812 ],
		'registered' => [ 58, -4, 777, 715 ],
		'ring' => [ 125, 468, 376, 721 ],
		's' => [ 84, 0, 580, 423 ],
		'S' => [ 116, 0, 692, 517 ],
		'Scaron' => [ 116, 0, 692, 740 ],
		'scaron' => [ 84, 0, 580, 647 ],
		'Scedilla' => [ 116, -232, 692, 517 ],
		'scedilla' => [ 84, -232, 580, 423 ],
		'section' => [ 62, -89, 442, 535 ],
		'semicolon' => [ 84, -132, 243, 424 ],
		'seven' => [ 106, -8, 680, 517 ],
		'sfthyphen' => [ 48, 215, 281, 318 ],
		'six' => [ 111, 0, 676, 529 ],
		'slash' => [ -23, -16, 302, 533 ],
		'space' => [ 0, 0, 0, 0 ],
		'sterling' => [ 105, -12, 717, 517 ],
		'summation' => [ 13, -191, 654, 720 ],
		't' => [ 40, 0, 551, 423 ],
		'T' => [ 16, 0, 610, 517 ],
		'Thorn' => [ 132, 0, 690, 517 ],
		'thorn' => [ 95, 0, 575, 423 ],
		'three' => [ 110, 0, 653, 517 ],
		'threequarters' => [ 69, -16, 1100, 533 ],
		'threesuperior' => [ 74, 207, 432, 517 ],
		'tilde' => [ 104, 496, 397, 617 ],
		'trademark' => [ 119, 450, 687, 712 ],
		'two' => [ 114, 0, 667, 517 ],
		'twosuperior' => [ 76, 207, 440, 517 ],
		'u' => [ 95, 0, 596, 423 ],
		'U' => [ 132, 0, 714, 517 ],
		'uacute' => [ 95, 0, 596, 647 ],
		'Uacute' => [ 132, 0, 714, 740 ],
		'Ucircumflex' => [ 132, 0, 714, 740 ],
		'ucircumflex' => [ 95, 0, 596, 647 ],
		'Udieresis' => [ 132, 0, 714, 706 ],
		'udieresis' => [ 95, 0, 596, 613 ],
		'ugrave' => [ 95, 0, 596, 647 ],
		'Ugrave' => [ 132, 0, 714, 740 ],
		'underscore' => [ 0, -235, 500, -166 ],
		'V' => [ 8, 0, 673, 517 ],
		'v' => [ 37, 0, 608, 423 ],
		'W' => [ 40, 0, 888, 517 ],
		'w' => [ 37, 0, 766, 423 ],
		...
		'Yacute' => [ 8, 0, 665, 740 ],
		'yacute' => [ 23, 0, 587, 647 ],
		'ydieresis' => [ 23, 0, 587, 613 ],
		'Ydieresis' => [ 8, 0, 665, 706 ],
		'yen' => [ 63, 0, 710, 517 ],
		'Z' => [ 62, 0, 616, 517 ],
		'z' => [ 70, 0, 547, 423 ],
		'Zcaron' => [ 62, 0, 616, 740 ],

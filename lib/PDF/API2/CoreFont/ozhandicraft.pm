...
$fonts->{'ozhandicraft'} = {
	...
	'bbox' => { 
		'.notdef' => [ 50, -176, 550, 706 ],
		'A' => [ -4, -7, 307, 762 ],
		'a' => [ 22, -11, 255, 570 ],
		'Aacute' => [ -4, -7, 307, 942 ],
		'aacute' => [ 22, -11, 255, 749 ],
		'Acircumflex' => [ -4, -7, 307, 943 ],
		'acircumflex' => [ 22, -11, 255, 750 ],
		'acute' => [ 201, 605, 332, 749 ],
		'Adieresis' => [ -4, -7, 307, 899 ],
		'adieresis' => [ 22, -11, 255, 706 ],
		'ae' => [ 16, -7, 424, 569 ],
		'AE' => [ 9, -13, 394, 759 ],
		'Agrave' => [ -4, -7, 307, 943 ],
		'agrave' => [ 22, -11, 255, 750 ],
		'ampersand' => [ 15, -13, 458, 764 ],
		'applelogo' => [ 56, -17, 735, 789 ],
		'approxequal' => [ 87, 141, 748, 457 ],
		'Aring' => [ -4, -7, 307, 896 ],
		'aring' => [ 22, -11, 255, 779 ],
		'asciicircum' => [ 207, 440, 793, 712 ],
		'asciitilde' => [ 87, 226, 748, 371 ],
		'asterisk' => [ 26, 491, 276, 765 ],
		'at' => [ 56, -140, 946, 712 ],
		'atilde' => [ 22, -11, 255, 716 ],
		'Atilde' => [ -4, -7, 307, 910 ],
		'B' => [ 38, -7, 296, 759 ],
		'b' => [ 19, -13, 278, 764 ],
		'backslash' => [ 0, -105, 311, 775 ],
		'bar' => [ 220, -235, 281, 765 ],
		'braceleft' => [ 84, -202, 419, 722 ],
		'braceright' => [ 82, -202, 417, 722 ],
		'bracketleft' => [ 48, -153, 226, 771 ],
		'bracketright' => [ -1, -153, 174, 771 ],
		'breve' => [ 163, 614, 342, 719 ],
		'brokenbar' => [ 220, -170, 281, 700 ],
		'bullet' => [ 150, 228, 439, 517 ],
		'c' => [ 22, -12, 224, 566 ],
		'C' => [ 20, -11, 269, 760 ],
		'Cacute' => [ 20, -11, 285, 942 ],
		'cacute' => [ 22, -12, 231, 749 ],
		'caron' => [ 163, 605, 342, 749 ],
		'ccaron' => [ 22, -12, 242, 749 ],
		'Ccaron' => [ 20, -11, 295, 942 ],
		'Ccedilla' => [ 20, -166, 269, 760 ],
		'ccedilla' => [ 22, -166, 224, 566 ],
		'cedilla' => [ 181, -166, 285, 5 ],
		'cent' => [ 22, -71, 225, 607 ],
		'circumflex' => [ 163, 605, 342, 750 ],
		'colon' => [ 42, -14, 145, 425 ],
		'comma' => [ 36, -138, 131, 98 ],
		'copyright' => [ 59, -4, 775, 713 ],
		'CR' => [ 0, 0, 0, 0 ],
		'currency' => [ -1, -12, 355, 760 ],
		'd' => [ 25, -8, 284, 754 ],
		'D' => [ 45, -6, 294, 756 ],
		'dagger' => [ 21, -11, 321, 763 ],
		'daggerdbl' => [ 24, -12, 318, 763 ],
		'degree' => [ 27, 435, 304, 710 ],
		'dieresis' => [ 159, 624, 346, 706 ],
		'divide' => [ 125, 66, 709, 530 ],
		'dollar' => [ 10, -118, 260, 750 ],
		'dotaccent' => [ 211, 629, 295, 716 ],
		'dotlessi' => [ 41, -7, 124, 563 ],
		'dslash' => [ 25, -8, 328, 754 ],
		'e' => [ 22, -12, 253, 567 ],
		'E' => [ 28, -12, 278, 756 ],
		'eacute' => [ 22, -12, 253, 749 ],
		'Eacute' => [ 28, -12, 278, 942 ],
		'ecircumflex' => [ 22, -12, 253, 750 ],
		'Ecircumflex' => [ 28, -12, 278, 943 ],
		'edieresis' => [ 22, -12, 256, 706 ],
		'Edieresis' => [ 28, -12, 278, 899 ],
		'egrave' => [ 22, -12, 253, 750 ],
		'Egrave' => [ 28, -12, 278, 943 ],
		'eight' => [ 14, -14, 295, 748 ],
		'ellipsis' => [ 114, -14, 877, 96 ],
		'emdash' => [ -6, 250, 1007, 307 ],
		'endash' => [ 31, 244, 468, 313 ],
		'equal' => [ 125, 176, 709, 420 ],
		'eth' => [ 24, -12, 267, 749 ],
		'Eth' => [ -6, -6, 299, 756 ],
		'euro' => [ -1, -12, 355, 760 ],
		'exclam' => [ 62, -2, 143, 709 ],
		'exclamdown' => [ 63, -2, 146, 709 ],
		'F' => [ 23, -11, 268, 763 ],
		'f' => [ 1, -83, 255, 750 ],
		'fi' => [ -15, -179, 281, 799 ],
		'five' => [ -12, -211, 247, 574 ],
		'fl' => [ 1, -92, 293, 771 ],
		'florin' => [ -5, -141, 254, 697 ],
		'four' => [ 0, -195, 353, 575 ],
		'fraction' => [ -130, -48, 297, 706 ],
		'franc' => [ 23, -11, 521, 763 ],
		'G' => [ 23, -22, 296, 772 ],
		'g' => [ -5, -203, 296, 567 ],
		'Gbreve' => [ 23, -22, 296, 913 ],
		'gbreve' => [ -5, -203, 296, 719 ],
		'germandbls' => [ -15, -45, 348, 759 ],
		'grave' => [ 183, 601, 298, 750 ],
		'greater' => [ 129, 38, 705, 560 ],
		'greaterequal' => [ 128, 17, 706, 583 ],
		'guillemotleft' => [ 20, 86, 300, 470 ],
		'guillemotright' => [ 24, 86, 306, 470 ],
		'guilsinglleft' => [ 20, 86, 199, 470 ],
		'guilsinglright' => [ 24, 86, 203, 470 ],
		'H' => [ 37, -11, 311, 762 ],
		'h' => [ 36, -5, 296, 759 ],
		'hungarumlaut' => [ 163, 605, 370, 749 ],
		'hyphen' => [ 21, 256, 180, 337 ],
		'i' => [ 34, -7, 131, 717 ],
		'I' => [ 42, -15, 126, 756 ],
		'Iacute' => [ 35, -15, 166, 942 ],
		'iacute' => [ 33, -7, 164, 749 ],
		'icircumflex' => [ -5, -7, 174, 750 ],
		'Icircumflex' => [ -3, -15, 176, 943 ],
		'idieresis' => [ -9, -7, 178, 706 ],
		'Idieresis' => [ -7, -15, 180, 899 ],
		'Idot' => [ 42, -15, 129, 910 ],
		'Igrave' => [ 17, -15, 132, 943 ],
		'igrave' => [ 15, -7, 130, 750 ],
		'increment' => [ -3, 0, 667, 720 ],
		'infinity' => [ 111, 112, 723, 487 ],
		'integral' => [ 23, -181, 476, 756 ],
		'J' => [ -22, -12, 206, 759 ],
		'j' => [ -28, -166, 132, 713 ],
		'K' => [ 29, -15, 342, 755 ],
		'k' => [ 31, -48, 308, 757 ],
		...
		'l' => [ 31, -6, 127, 757 ],
		'less' => [ 129, 38, 705, 560 ],
		'lessequal' => [ 128, 17, 706, 583 ],
		'logicalnot' => [ 125, 174, 709, 419 ],
		'lozenge' => [ 3, -232, 492, 808 ],
		'lslash' => [ -13, -6, 192, 757 ],
		'Lslash' => [ -11, -18, 298, 764 ],
		'M' => [ 28, -9, 385, 758 ],
		'm' => [ 15, -9, 449, 567 ],
		'middot' => [ 38, 229, 138, 329 ],
		'minus' => [ 125, 270, 709, 328 ],
		'mu1' => [ -54, -208, 514, 522 ],
		'multiply' => [ 147, 26, 691, 571 ],
		'n' => [ 27, -4, 288, 567 ],
		'N' => [ 39, -26, 309, 762 ],
		'nbspace' => [ 0, 0, 0, 0 ],
		'nine' => [ 24, -223, 285, 574 ],
		'notequal' => [ 125, 21, 709, 577 ],
		'Ntilde' => [ 39, -26, 309, 910 ],
		'ntilde' => [ 27, -4, 288, 716 ],
		'null' => [ 0, 0, 0, 0 ],
		'numbersign' => [ 51, 0, 718, 711 ],
		'o' => [ 24, -12, 266, 567 ],
		'O' => [ 23, -11, 316, 763 ],
		'Oacute' => [ 23, -11, 316, 942 ],
		'oacute' => [ 24, -12, 266, 749 ],
		'Ocircumflex' => [ 23, -11, 316, 943 ],
		'ocircumflex' => [ 24, -12, 266, 750 ],
		'Odieresis' => [ 23, -11, 316, 899 ],
		'odieresis' => [ 24, -12, 266, 706 ],
		'OE' => [ 23, -11, 451, 763 ],
		'oe' => [ 23, -15, 423, 575 ],
		'ogonek' => [ 180, -214, 314, 16 ],
		'Ograve' => [ 23, -11, 316, 943 ],
		'ograve' => [ 24, -12, 266, 750 ],
		'Omega' => [ 49, 0, 720, 739 ],
		'one' => [ -15, -13, 182, 568 ],
		'onehalf' => [ -8, -48, 498, 706 ],
		'onequarter' => [ -8, -109, 534, 706 ],
		'onesuperior' => [ -9, 267, 120, 616 ],
		'ordfeminine' => [ 18, 356, 191, 764 ],
		'ordmasculine' => [ 19, 356, 200, 762 ],
		'oslash' => [ 22, -102, 275, 647 ],
		'Oslash' => [ 23, -117, 316, 852 ],
		'otilde' => [ 24, -12, 266, 716 ],
		'Otilde' => [ 23, -11, 316, 910 ],
		'overscore' => [ 166, 620, 335, 689 ],
		'p' => [ 37, -194, 275, 567 ],
		'P' => [ 40, -5, 291, 753 ],
		'paragraph' => [ 38, 0, 463, 723 ],
		'parenleft' => [ 33, -193, 219, 791 ],
		'parenright' => [ 3, -193, 190, 791 ],
		'partialdiff' => [ 58, -12, 458, 643 ],
		'percent' => [ 23, -48, 517, 706 ],
		'period' => [ 35, -14, 131, 96 ],
		'periodcentered' => [ 38, 229, 138, 329 ],
		'perthousand' => [ 23, -48, 779, 706 ],
		'pi' => [ -7, -7, 570, 522 ],
		'plus' => [ 125, 0, 709, 597 ],
		'plusminus' => [ 125, 21, 709, 577 ],
		'product' => [ 79, -191, 668, 720 ],
		'q' => [ 19, -193, 275, 569 ],
		'Q' => [ 22, -161, 348, 763 ],
		'question' => [ 35, -2, 228, 711 ],
		'questiondown' => [ 33, -4, 227, 709 ],
		'quotedbl' => [ 46, 431, 243, 701 ],
		'quotedblbase' => [ 34, -109, 269, 99 ],
		'quotedblleft' => [ 37, 556, 271, 764 ],
		'quotedblright' => [ 34, 556, 269, 764 ],
		'quoteleft' => [ 37, 556, 142, 764 ],
		'quoteright' => [ 34, 556, 140, 764 ],
		'quotesinglbase' => [ 34, -109, 140, 99 ],
		'quotesingle' => [ 46, 431, 104, 701 ],
		'R' => [ 37, -8, 305, 762 ],
		'r' => [ 29, -7, 257, 566 ],
		'radical' => [ 28, -20, 629, 805 ],
		'registered' => [ 59, -4, 775, 713 ],
		'ring' => [ 158, 595, 342, 779 ],
		's' => [ 18, -30, 173, 593 ],
		'S' => [ 17, -49, 209, 773 ],
		'Scaron' => [ 17, -49, 209, 942 ],
		'scaron' => [ 13, -30, 192, 749 ],
		'Scedilla' => [ 17, -166, 209, 773 ],
		'scedilla' => [ 18, -166, 173, 593 ],
		'section' => [ 27, -166, 313, 763 ],
		'semicolon' => [ 42, -141, 145, 425 ],
		'seven' => [ 6, -229, 260, 574 ],
		'sfthyphen' => [ 21, 256, 180, 337 ],
		'six' => [ 25, -22, 306, 765 ],
		'slash' => [ -24, -105, 286, 775 ],
		'space' => [ 0, 0, 0, 0 ],
		'sterling' => [ 25, -9, 278, 670 ],
		'summation' => [ 9, -191, 639, 720 ],
		't' => [ 4, -19, 252, 655 ],
		'T' => [ 12, -6, 294, 758 ],
		'Thorn' => [ 35, -5, 271, 754 ],
		'thorn' => [ 35, -189, 275, 756 ],
		'three' => [ 10, -240, 248, 567 ],
		'threequarters' => [ 6, -109, 565, 706 ],
		'threesuperior' => [ 7, 130, 164, 614 ],
		'tilde' => [ 150, 616, 355, 716 ],
		'trademark' => [ 125, 451, 679, 711 ],
		'two' => [ -7, -5, 295, 567 ],
		'twosuperior' => [ -4, 271, 195, 614 ],
		'u' => [ 28, -6, 272, 570 ],
		'U' => [ 36, -13, 299, 762 ],
		'uacute' => [ 28, -6, 272, 749 ],
		'Uacute' => [ 36, -13, 299, 942 ],
		'Ucircumflex' => [ 36, -13, 299, 943 ],
		'ucircumflex' => [ 28, -6, 272, 750 ],
		'Udieresis' => [ 36, -13, 299, 899 ],
		'udieresis' => [ 28, -6, 272, 706 ],
		'ugrave' => [ 28, -6, 272, 750 ],
		'Ugrave' => [ 36, -13, 299, 943 ],
		'underscore' => [ 0, -235, 500, -178 ],
		'V' => [ 4, -13, 316, 769 ],
		'v' => [ 5, -15, 294, 568 ],
		'W' => [ 37, -4, 415, 759 ],
		'w' => [ -2, -15, 415, 570 ],
		...
		'y' => [ 5, -209, 279, 568 ],
		'Yacute' => [ -7, -17, 263, 942 ],
		'yacute' => [ 5, -209, 279, 749 ],
		'ydieresis' => [ 5, -209, 279, 706 ],
		'Ydieresis' => [ -7, -17, 263, 899 ],
		'yen' => [ -4, -16, 259, 675 ],
		'Z' => [ 20, -8, 249, 755 ],
		'z' => [ 9, -6, 255, 564 ],
		'Zcaron' => [ 20, -8, 249, 942 ],

...
easily exchange them, e.g.
	...
	BEGIN {
	  ...
	  if ($@) { # ups, no Digest::MD5
	    require PDF::API2::MD5;
	    import PDF::API2::MD5 'md5_hex'
	  }		
	}
...
C<PDF::API2::MD5> loads all data to encrypt into memory. This is a todo.
...
modify it under the same terms as Perl itself.
 ...
 Copyright 2001 Alfred Reibenschuh, modified from Digest::Perl::MD5

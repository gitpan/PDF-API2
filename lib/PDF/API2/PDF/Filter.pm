...
package PDF::API2::PDF::ASCII85Decode;

use strict;
use vars qw(@ISA);
@ISA = qw(PDF::API2::PDF::Filter);
# no warnings qw(uninitialized);

=head1 NAME

PDF::API2::PDF::ASCII85Decode - Ascii85 filter for PDF streams. Inherits from
L<PDF::API2::PDF::Filter>
...
package PDF::API2::PDF::RunLengthDecode;
...
PDF::API2::PDF::RunLengthDecode - Run Length encoding filter for PDF streams. Inherits from
L<PDF::API2::PDF::Filter>
...
package PDF::API2::PDF::ASCIIHexDecode;
...
PDF::API2::PDF::ASCIIHexDecode - Ascii Hex encoding (very inefficient) for PDF streams.
Inherits from L<PDF::API2::PDF::Filter>
...
package PDF::API2::PDF::FlateDecode;
...
package PDF::API2::PDF::LZWDecode;

use vars qw(@ISA @basedict);
@ISA = qw(PDF::API2::PDF::FlateDecode);

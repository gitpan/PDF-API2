...
PDF::API2::PDF::Name - Inherits from L<PDF::API2::PDF::String> and stores PDF names (things
beginning with /)

=head1 METHODS

=head2 PDF::API2::PDF::Name->from_pdf($string)
...
=head2 PDF::API2::PDF::Name->string_to_name ($str, $pdf)
...
=head2 PDF::API2::PDF::Name->name_to_string ($str, $pdf)

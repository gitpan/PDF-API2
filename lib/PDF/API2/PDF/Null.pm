package PDF::API2::PDF::Null;

=head1 NAME

PDF::API2::PDF::Null - PDF Null type object.  This is a subclass of
PDF::API2::PDF::Objind and cannot be subclassed.
...
my ($null_obj) = {};
bless $null_obj, "PDF::API2::PDF::Null";


=head2 PDF::API2::PDF::Null->new

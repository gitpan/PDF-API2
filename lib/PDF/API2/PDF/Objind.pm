package PDF::API2::PDF::Objind;

=head1 NAME

PDF::API2::PDF::Objind - PDF indirect object reference. Also acts as an abstract
...
'C<PDF::API2::PDF::File-E<gt>release>' (so you don't have to call it yourself).
...
the C<PDF::API2::PDF::Objind> object.  This is done to help ensure that unexpected

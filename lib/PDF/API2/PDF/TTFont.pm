package PDF::API2::PDF::TTFont;

=head1 NAME

PDF::API2::PDF::TTFont - Inherits from L<PDF::API2::PDF::Dict> and represents a TrueType
...
=head2 PDF::API2::PDF::TTFont->new($parent, $fontfname, $pdfname, %opts)
...
sub outobjdeep
{
    ...
    if ($self->{' subset'})
    {
        ...
        $s->{' stream'} = "";
        $ffh = PDF::API2::PDF::TTIOString->new(\$s->{' stream'});
...
package PDF::API2::PDF::TTIOString;

=head1 TITLE

PDF::API2::PDF::TTIOString - internal IO type handle for string output for font

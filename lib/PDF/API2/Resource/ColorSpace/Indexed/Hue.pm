...
#
#   $Id: Hue.pm,v 1.8 2005/06/17 18:53:34 fredo Exp $
#
#=======================================================================
...
BEGIN {
    ...
    ( $VERSION ) = sprintf '%i.%03i', split(/\./,('$Revision: 1.8 $' =~ /Revision: (\S+)\s/)[0]); # $Date: 2005/06/17 18:53:34 $

}
no warnings qw[ deprecated recursion uninitialized ];

=item $cs = PDF::API2::Resource::ColorSpace::Indexed::Hue->new $pdf

...
#
#   $Id: Font.pm,v 1.16 2005/09/26 20:06:02 fredo Exp $
#
#=======================================================================
...
BEGIN {
    ...
    ( $VERSION ) = sprintf '%i.%03i', split(/\./,('$Revision: 1.16 $' =~ /Revision: (\S+)\s/)[0]); # $Date: 2005/09/26 20:06:02 $

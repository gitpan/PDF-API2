...
#
#   $Id: bankgothic.pm,v 2.0 2005/11/16 02:18:14 areibens Exp $
#
#=======================================================================
...
$FONTDATA = {
    ...
    'wx' => { # HORIZ. WIDTH TABLE
        'space' => '388',                        # C+0x20 # U+0x0020
        'exclam' => '384',                       # C+0x21 # U+0x0021
        'quotedbl' => '300',                     # C+0x22 # U+0x0022
        'numbersign' => '770',                   # C+0x23 # U+0x0023
        'dollar' => '773',                       # C+0x24 # U+0x0024
        'percent' => '799',                      # C+0x25 # U+0x0025
        'ampersand' => '825',                    # C+0x26 # U+0x0026
        'quotesingle' => '155',                  # C+0x27 # U+0x0027
        'parenleft' => '332',                    # C+0x28 # U+0x0028
        'parenright' => '332',                   # C+0x29 # U+0x0029
        'asterisk' => '500',                     # C+0x2A # U+0x002A
        'plus' => '834',                         # C+0x2B # U+0x002B
        'comma' => '332',                        # C+0x2C # U+0x002C
        'hyphen' => '331',                       # C+0x2D # U+0x002D
        'period' => '332',                       # C+0x2E # U+0x002E
        'slash' => '278',                        # C+0x2F # U+0x002F
        'zero' => '773',                         # C+0x30 # U+0x0030
        'one' => '773',                          # C+0x31 # U+0x0031
        'two' => '773',                          # C+0x32 # U+0x0032
        'three' => '773',                        # C+0x33 # U+0x0033
        'four' => '773',                         # C+0x34 # U+0x0034
        'five' => '773',                         # C+0x35 # U+0x0035
        'six' => '773',                          # C+0x36 # U+0x0036
        'seven' => '773',                        # C+0x37 # U+0x0037
        'eight' => '773',                        # C+0x38 # U+0x0038
        'nine' => '773',                         # C+0x39 # U+0x0039
        'colon' => '332',                        # C+0x3A # U+0x003A
        'semicolon' => '332',                    # C+0x3B # U+0x003B
        'less' => '834',                         # C+0x3C # U+0x003C
        'equal' => '834',                        # C+0x3D # U+0x003D
        'greater' => '834',                      # C+0x3E # U+0x003E
        'question' => '663',                     # C+0x3F # U+0x003F
        'at' => '1000',                          # C+0x40 # U+0x0040
        'A' => '771',                            # C+0x41 # U+0x0041
        'B' => '794',                            # C+0x42 # U+0x0042
        'C' => '801',                            # C+0x43 # U+0x0043
        'D' => '848',                            # C+0x44 # U+0x0044
        'E' => '755',                            # C+0x45 # U+0x0045
        'F' => '671',                            # C+0x46 # U+0x0046
        'G' => '855',                            # C+0x47 # U+0x0047
        'H' => '880',                            # C+0x48 # U+0x0048
        'I' => '384',                            # C+0x49 # U+0x0049
        'J' => '667',                            # C+0x4A # U+0x004A
        'K' => '794',                            # C+0x4B # U+0x004B
        'L' => '684',                            # C+0x4C # U+0x004C
        'M' => '926',                            # C+0x4D # U+0x004D
        'N' => '870',                            # C+0x4E # U+0x004E
        'O' => '878',                            # C+0x4F # U+0x004F
        'P' => '744',                            # C+0x50 # U+0x0050
        'Q' => '878',                            # C+0x51 # U+0x0051
        'R' => '802',                            # C+0x52 # U+0x0052
        'S' => '810',                            # C+0x53 # U+0x0053
        'T' => '625',                            # C+0x54 # U+0x0054
        'U' => '847',                            # C+0x55 # U+0x0055
        'V' => '682',                            # C+0x56 # U+0x0056
        'W' => '926',                            # C+0x57 # U+0x0057
        'X' => '718',                            # C+0x58 # U+0x0058
        'Y' => '672',                            # C+0x59 # U+0x0059
        'Z' => '683',                            # C+0x5A # U+0x005A
        'bracketleft' => '332',                  # C+0x5B # U+0x005B
        'backslash' => '278',                    # C+0x5C # U+0x005C
        'bracketright' => '332',                 # C+0x5D # U+0x005D
        'asciicircum' => '1000',                 # C+0x5E # U+0x005E
        'underscore' => '500',                   # C+0x5F # U+0x005F
        'grave' => '500',                        # C+0x60 # U+0x0060
        'a' => '646',                            # C+0x61 # U+0x0061
        'b' => '658',                            # C+0x62 # U+0x0062
        'c' => '645',                            # C+0x63 # U+0x0063
        'd' => '694',                            # C+0x64 # U+0x0064
        'e' => '608',                            # C+0x65 # U+0x0065
        'f' => '550',                            # C+0x66 # U+0x0066
        'g' => '692',                            # C+0x67 # U+0x0067
        'h' => '718',                            # C+0x68 # U+0x0068
        'i' => '292',                            # C+0x69 # U+0x0069
        'j' => '561',                            # C+0x6A # U+0x006A
        'k' => '621',                            # C+0x6B # U+0x006B
        'l' => '552',                            # C+0x6C # U+0x006C
        'm' => '768',                            # C+0x6D # U+0x006D
        'n' => '712',                            # C+0x6E # U+0x006E
        'o' => '715',                            # C+0x6F # U+0x006F
        'p' => '628',                            # C+0x70 # U+0x0070
        'q' => '715',                            # C+0x71 # U+0x0071
        'r' => '650',                            # C+0x72 # U+0x0072
        's' => '664',                            # C+0x73 # U+0x0073
        't' => '590',                            # C+0x74 # U+0x0074
        'u' => '689',                            # C+0x75 # U+0x0075
        'v' => '632',                            # C+0x76 # U+0x0076
        'w' => '790',                            # C+0x77 # U+0x0077
        'x' => '639',                            # C+0x78 # U+0x0078
        'y' => '593',                            # C+0x79 # U+0x0079
        'z' => '617',                            # C+0x7A # U+0x007A
        'braceleft' => '500',                    # C+0x7B # U+0x007B
        'bar' => '500',                          # C+0x7C # U+0x007C
        'braceright' => '500',                   # C+0x7D # U+0x007D
        'asciitilde' => '834',                   # C+0x7E # U+0x007E
        'bullet' => '590',                       # C+0x7F # U+0x2022
        'quotesinglbase' => '332',               # C+0x82 # U+0x201A
        'florin' => '773',                       # C+0x83 # U+0x0192
        'quotedblbase' => '580',                 # C+0x84 # U+0x201E
        'ellipsis' => '1000',                    # C+0x85 # U+0x2026
        'dagger' => '500',                       # C+0x86 # U+0x2020
        'daggerdbl' => '500',                    # C+0x87 # U+0x2021
        'circumflex' => '500',                   # C+0x88 # U+0x02C6
        'perthousand' => '1161',                 # C+0x89 # U+0x2030
        'Scaron' => '810',                       # C+0x8A # U+0x0160
        'guilsinglleft' => '332',                # C+0x8B # U+0x2039
        'OE' => '1105',                          # C+0x8C # U+0x0152
        'Zcaron' => '683',                       # C+0x8E # U+0x017D
        'quoteleft' => '332',                    # C+0x91 # U+0x2018
        'quoteright' => '332',                   # C+0x92 # U+0x2019
        'quotedblleft' => '580',                 # C+0x93 # U+0x201C
        'quotedblright' => '580',                # C+0x94 # U+0x201D
        'endash' => '500',                       # C+0x96 # U+0x2013
        'emdash' => '1000',                      # C+0x97 # U+0x2014
        'tilde' => '500',                        # C+0x98 # U+0x02DC
        'trademark' => '834',                    # C+0x99 # U+0x2122
        'scaron' => '664',                       # C+0x9A # U+0x0161
        'guilsinglright' => '332',               # C+0x9B # U+0x203A
        'oe' => '908',                           # C+0x9C # U+0x0153
        'zcaron' => '617',                       # C+0x9E # U+0x017E
        'Ydieresis' => '672',                    # C+0x9F # U+0x0178
        'exclamdown' => '384',                   # C+0xA1 # U+0x00A1
        'cent' => '773',                         # C+0xA2 # U+0x00A2
        'sterling' => '773',                     # C+0xA3 # U+0x00A3
        'currency' => '773',                     # C+0xA4 # U+0x00A4
        'yen' => '773',                          # C+0xA5 # U+0x00A5
        'brokenbar' => '500',                    # C+0xA6 # U+0x00A6
        'section' => '500',                      # C+0xA7 # U+0x00A7
        'dieresis' => '500',                     # C+0xA8 # U+0x00A8
        'copyright' => '834',                    # C+0xA9 # U+0x00A9
        'ordfeminine' => '426',                  # C+0xAA # U+0x00AA
        ...
        'onesuperior' => '510',                  # C+0xB9 # U+0x00B9
        'ordmasculine' => '473',                 # C+0xBA # U+0x00BA
        'guillemotright' => '563',               # C+0xBB # U+0x00BB
        'onequarter' => '1142',                  # C+0xBC # U+0x00BC
        'onehalf' => '1142',                     # C+0xBD # U+0x00BD
        'threequarters' => '1142',               # C+0xBE # U+0x00BE
        'questiondown' => '663',                 # C+0xBF # U+0x00BF
        'Agrave' => '771',                       # C+0xC0 # U+0x00C0
        'Aacute' => '771',                       # C+0xC1 # U+0x00C1
        'Acircumflex' => '771',                  # C+0xC2 # U+0x00C2
        'Atilde' => '771',                       # C+0xC3 # U+0x00C3
        'Adieresis' => '771',                    # C+0xC4 # U+0x00C4
        'Aring' => '771',                        # C+0xC5 # U+0x00C5
        'AE' => '1069',                          # C+0xC6 # U+0x00C6
        'Ccedilla' => '801',                     # C+0xC7 # U+0x00C7
        'Egrave' => '755',                       # C+0xC8 # U+0x00C8
        'Eacute' => '755',                       # C+0xC9 # U+0x00C9
        'Ecircumflex' => '755',                  # C+0xCA # U+0x00CA
        'Edieresis' => '755',                    # C+0xCB # U+0x00CB
        'Igrave' => '384',                       # C+0xCC # U+0x00CC
        'Iacute' => '384',                       # C+0xCD # U+0x00CD
        'Icircumflex' => '384',                  # C+0xCE # U+0x00CE
        'Idieresis' => '384',                    # C+0xCF # U+0x00CF
        'Eth' => '848',                          # C+0xD0 # U+0x00D0
        'Ntilde' => '870',                       # C+0xD1 # U+0x00D1
        'Ograve' => '878',                       # C+0xD2 # U+0x00D2
        'Oacute' => '878',                       # C+0xD3 # U+0x00D3
        'Ocircumflex' => '878',                  # C+0xD4 # U+0x00D4
        'Otilde' => '878',                       # C+0xD5 # U+0x00D5
        'Odieresis' => '878',                    # C+0xD6 # U+0x00D6
        'multiply' => '834',                     # C+0xD7 # U+0x00D7
        'Oslash' => '878',                       # C+0xD8 # U+0x00D8
        'Ugrave' => '847',                       # C+0xD9 # U+0x00D9
        'Uacute' => '847',                       # C+0xDA # U+0x00DA
        'Ucircumflex' => '847',                  # C+0xDB # U+0x00DB
        ...
        'atilde' => '646',                       # C+0xE3 # U+0x00E3
        'adieresis' => '646',                    # C+0xE4 # U+0x00E4
        'aring' => '646',                        # C+0xE5 # U+0x00E5
        'ae' => '898',                           # C+0xE6 # U+0x00E6
        'ccedilla' => '645',                     # C+0xE7 # U+0x00E7
        'egrave' => '608',                       # C+0xE8 # U+0x00E8
        'eacute' => '608',                       # C+0xE9 # U+0x00E9
        'ecircumflex' => '608',                  # C+0xEA # U+0x00EA
        'edieresis' => '608',                    # C+0xEB # U+0x00EB
        'igrave' => '292',                       # C+0xEC # U+0x00EC
        'iacute' => '292',                       # C+0xED # U+0x00ED
        'icircumflex' => '292',                  # C+0xEE # U+0x00EE
        'idieresis' => '292',                    # C+0xEF # U+0x00EF
        'eth' => '694',                          # C+0xF0 # U+0x00F0
        'ntilde' => '712',                       # C+0xF1 # U+0x00F1
        'ograve' => '715',                       # C+0xF2 # U+0x00F2
        'oacute' => '715',                       # C+0xF3 # U+0x00F3
        'ocircumflex' => '715',                  # C+0xF4 # U+0x00F4
        'otilde' => '715',                       # C+0xF5 # U+0x00F5
        'odieresis' => '715',                    # C+0xF6 # U+0x00F6
        'divide' => '834',                       # C+0xF7 # U+0x00F7
        'oslash' => '715',                       # C+0xF8 # U+0x00F8
        'ugrave' => '689',                       # C+0xF9 # U+0x00F9
        'uacute' => '689',                       # C+0xFA # U+0x00FA
        'ucircumflex' => '689',                  # C+0xFB # U+0x00FB
        'udieresis' => '689',                    # C+0xFC # U+0x00FC
        'yacute' => '593',                       # C+0xFD # U+0x00FD
        'thorn' => '628',                        # C+0xFE # U+0x00FE
        'ydieresis' => '593',                    # C+0xFF # U+0x00FF
        'dotlessi' => '292',                     # U+0x0131
        'Lslash' => '684',                       # U+0x0141
        'lslash' => '552',                       # U+0x0142
        'caron' => '500',                        # U+0x02C7
        'breve' => '500',                        # U+0x02D8

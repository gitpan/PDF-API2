...
#
#   $Id: georgia.pm,v 1.3 2003/12/08 13:06:03 Administrator Exp $
#
#=======================================================================
...
$fonts->{georgia}= {
    ...
    'wx' => { # HORIZ. WIDTH TABLE
        ...
        'seven' => '502',                        # C+0x37 # U+0x0037
        'eight' => '596',                        # C+0x38 # U+0x0038
        'nine' => '565',                         # C+0x39 # U+0x0039
        'colon' => '312',                        # C+0x3A # U+0x003A
        'semicolon' => '312',                    # C+0x3B # U+0x003B
        ...
        'O' => '744',                            # C+0x4F # U+0x004F
        'P' => '609',                            # C+0x50 # U+0x0050
        'Q' => '744',                            # C+0x51 # U+0x0051
        ...
        'a' => '503',                            # C+0x61 # U+0x0061
        'b' => '560',                            # C+0x62 # U+0x0062
        'c' => '454',                            # C+0x63 # U+0x0063
        'd' => '574',                            # C+0x64 # U+0x0064
        'e' => '483',                            # C+0x65 # U+0x0065
        'f' => '325',                            # C+0x66 # U+0x0066
        'g' => '509',                            # C+0x67 # U+0x0067
        'h' => '582',                            # C+0x68 # U+0x0068
        'i' => '292',                            # C+0x69 # U+0x0069
        'j' => '291',                            # C+0x6A # U+0x006A
        'k' => '535',                            # C+0x6B # U+0x006B
        'l' => '286',                            # C+0x6C # U+0x006C
        'm' => '880',                            # C+0x6D # U+0x006D
        'n' => '590',                            # C+0x6E # U+0x006E
        'o' => '539',                            # C+0x6F # U+0x006F
        'p' => '571',                            # C+0x70 # U+0x0070
        'q' => '559',                            # C+0x71 # U+0x0071
        'r' => '409',                            # C+0x72 # U+0x0072
        's' => '432',                            # C+0x73 # U+0x0073
        't' => '345',                            # C+0x74 # U+0x0074
        'u' => '575',                            # C+0x75 # U+0x0075
        'v' => '496',                            # C+0x76 # U+0x0076
        'w' => '737',                            # C+0x77 # U+0x0077
        'x' => '504',                            # C+0x78 # U+0x0078
        'y' => '492',                            # C+0x79 # U+0x0079
        ...
        'germandbls' => '548',                   # C+0xDF # U+0x00DF
        'agrave' => '503',                       # C+0xE0 # U+0x00E0
        'aacute' => '503',                       # C+0xE1 # U+0x00E1
        'acircumflex' => '503',                  # C+0xE2 # U+0x00E2
        'atilde' => '503',                       # C+0xE3 # U+0x00E3
        'adieresis' => '503',                    # C+0xE4 # U+0x00E4
        'aring' => '503',                        # C+0xE5 # U+0x00E5
        'ae' => '736',                           # C+0xE6 # U+0x00E6
        'ccedilla' => '454',                     # C+0xE7 # U+0x00E7
        'egrave' => '483',                       # C+0xE8 # U+0x00E8
        'eacute' => '483',                       # C+0xE9 # U+0x00E9
        'ecircumflex' => '483',                  # C+0xEA # U+0x00EA
        'edieresis' => '483',                    # C+0xEB # U+0x00EB
        'igrave' => '292',                       # C+0xEC # U+0x00EC
        'iacute' => '292',                       # C+0xED # U+0x00ED
        'icircumflex' => '292',                  # C+0xEE # U+0x00EE
        'idieresis' => '292',                    # C+0xEF # U+0x00EF
        'eth' => '531',                          # C+0xF0 # U+0x00F0
        'ntilde' => '590',                       # C+0xF1 # U+0x00F1
        'ograve' => '539',                       # C+0xF2 # U+0x00F2
        'oacute' => '539',                       # C+0xF3 # U+0x00F3
        'ocircumflex' => '539',                  # C+0xF4 # U+0x00F4
        'otilde' => '539',                       # C+0xF5 # U+0x00F5
        'odieresis' => '539',                    # C+0xF6 # U+0x00F6
        'divide' => '643',                       # C+0xF7 # U+0x00F7
        'oslash' => '539',                       # C+0xF8 # U+0x00F8
        'ugrave' => '575',                       # C+0xF9 # U+0x00F9
        'uacute' => '575',                       # C+0xFA # U+0x00FA
        'ucircumflex' => '575',                  # C+0xFB # U+0x00FB
        'udieresis' => '575',                    # C+0xFC # U+0x00FC
        'yacute' => '492',                       # C+0xFD # U+0x00FD
        'thorn' => '559',                        # C+0xFE # U+0x00FE
        'ydieresis' => '492',                    # C+0xFF # U+0x00FF
        'middot' => '279',                       # U+0x00B7
        'Amacron' => '670',                      # U+0x0100
        'amacron' => '503',                      # U+0x0101
        'Abreve' => '670',                       # U+0x0102
        'abreve' => '503',                       # U+0x0103
        'Aogonek' => '670',                      # U+0x0104
        'aogonek' => '503',                      # U+0x0105
        'Cacute' => '642',                       # U+0x0106
        'cacute' => '454',                       # U+0x0107
        'Ccircumflex' => '642',                  # U+0x0108
        'ccircumflex' => '454',                  # U+0x0109
        'Cdotaccent' => '642',                   # U+0x010A
        'cdotaccent' => '454',                   # U+0x010B
        'Ccaron' => '642',                       # U+0x010C
        'ccaron' => '454',                       # U+0x010D
        'Dcaron' => '749',                       # U+0x010E
        'dcaron' => '665',                       # U+0x010F
        ...
        'emacron' => '483',                      # U+0x0113
        'Ebreve' => '653',                       # U+0x0114
        'ebreve' => '483',                       # U+0x0115
        'Edotaccent' => '653',                   # U+0x0116
        'edotaccent' => '483',                   # U+0x0117
        'Eogonek' => '653',                      # U+0x0118
        'eogonek' => '483',                      # U+0x0119
        'Ecaron' => '653',                       # U+0x011A
        'ecaron' => '483',                       # U+0x011B
        'Gcircumflex' => '725',                  # U+0x011C
        'gcircumflex' => '509',                  # U+0x011D
        'Gbreve' => '725',                       # U+0x011E
        'gbreve' => '509',                       # U+0x011F
        'Gdotaccent' => '725',                   # U+0x0120
        'gdotaccent' => '509',                   # U+0x0121
        'Gcommaaccent' => '725',                 # U+0x0122
        'gcommaaccent' => '509',                 # U+0x0123
        'Hcircumflex' => '814',                  # U+0x0124
        'hcircumflex' => '582',                  # U+0x0125
        'Hbar' => '814',                         # U+0x0126
        'hbar' => '582',                         # U+0x0127
        'Itilde' => '389',                       # U+0x0128
        'itilde' => '292',                       # U+0x0129
        'Imacron' => '389',                      # U+0x012A
        'imacron' => '292',                      # U+0x012B
        'Ibreve' => '389',                       # U+0x012C
        'ibreve' => '292',                       # U+0x012D
        'Iogonek' => '389',                      # U+0x012E
        'iogonek' => '292',                      # U+0x012F
        ...
        'kcommaaccent' => '535',                 # U+0x0137
        'kgreenlandic' => '544',                 # U+0x0138
        'Lacute' => '603',                       # U+0x0139
        'lacute' => '286',                       # U+0x013A
        'Lcommaaccent' => '603',                 # U+0x013B
        'lcommaaccent' => '286',                 # U+0x013C
        'Lcaron' => '603',                       # U+0x013D
        'lcaron' => '376',                       # U+0x013E
        'Ldot' => '603',                         # U+0x013F
        'ldot' => '420',                         # U+0x0140
        ...
        'ncommaaccent' => '590',                 # U+0x0146
        'Ncaron' => '767',                       # U+0x0147
        'ncaron' => '590',                       # U+0x0148
        'napostrophe' => '644',                  # U+0x0149
        'Eng' => '767',                          # U+0x014A
        'eng' => '578',                          # U+0x014B
        'Omacron' => '744',                      # U+0x014C
        'omacron' => '539',                      # U+0x014D
        'Obreve' => '744',                       # U+0x014E
        'obreve' => '539',                       # U+0x014F
        'Ohungarumlaut' => '744',                # U+0x0150
        'ohungarumlaut' => '539',                # U+0x0151
        'Racute' => '701',                       # U+0x0154
        'racute' => '409',                       # U+0x0155
        'Rcommaaccent' => '701',                 # U+0x0156
        'rcommaaccent' => '409',                 # U+0x0157
        'Rcaron' => '701',                       # U+0x0158
        'rcaron' => '409',                       # U+0x0159
        'Sacute' => '561',                       # U+0x015A
        'sacute' => '432',                       # U+0x015B
        'Scircumflex' => '561',                  # U+0x015C
        'scircumflex' => '432',                  # U+0x015D
        'Scedilla' => '561',                     # U+0x015E
        'scedilla' => '432',                     # U+0x015F
        'Tcommaaccent' => '618',                 # U+0x0162
        'tcommaaccent' => '345',                 # U+0x0163
        'Tcaron' => '618',                       # U+0x0164
        'tcaron' => '345',                       # U+0x0165
        'Tbar' => '618',                         # U+0x0166
        'tbar' => '345',                         # U+0x0167
        ...
        'wcircumflex' => '737',                  # U+0x0175
        'Ycircumflex' => '615',                  # U+0x0176
        'ycircumflex' => '492',                  # U+0x0177
        'Zacute' => '601',                       # U+0x0179
        'zacute' => '443',                       # U+0x017A
        ...
        'aringacute' => '503',                   # U+0x01FB
        'AEacute' => '970',                      # U+0x01FC
        'aeacute' => '736',                      # U+0x01FD
        'Oslashacute' => '744',                  # U+0x01FE
        'oslashacute' => '539',                  # U+0x01FF
        'Scommaaccent' => '561',                 # U+0x0218
        'scommaaccent' => '432',                 # U+0x0219
        'caron' => '500',                        # U+0x02C7
        'breve' => '500',                        # U+0x02D8
        ...
        'anoteleia' => '312',                    # U+0x0387
        'Epsilontonos' => '798',                 # U+0x0388
        'Etatonos' => '959',                     # U+0x0389
        'Iotatonos' => '532',                    # U+0x038A
        'Omicrontonos' => '851',                 # U+0x038C
        'Upsilontonos' => '800',                 # U+0x038E
        'Omegatonos' => '876',                   # U+0x038F
        'iotadieresistonos' => '295',            # U+0x0390
        'Alpha' => '670',                        # U+0x0391
        'Beta' => '653',                         # U+0x0392
        'Gamma' => '583',                        # U+0x0393
        'Delta' => '660',                        # U+0x0394
        ...
        'alphatonos' => '597',                   # U+0x03AC
        'epsilontonos' => '468',                 # U+0x03AD
        'etatonos' => '570',                     # U+0x03AE
        'iotatonos' => '295',                    # U+0x03AF
        'upsilondieresistonos' => '541',         # U+0x03B0
        'alpha' => '597',                        # U+0x03B1
        'beta' => '565',                         # U+0x03B2
        'gamma' => '513',                        # U+0x03B3
        'delta' => '539',                        # U+0x03B4
        'epsilon' => '468',                      # U+0x03B5
        'zeta' => '403',                         # U+0x03B6
        'eta' => '570',                          # U+0x03B7
        'theta' => '556',                        # U+0x03B8
        'iota' => '295',                         # U+0x03B9
        ...
        'nu' => '501',                           # U+0x03BD
        'xi' => '440',                           # U+0x03BE
        'omicron' => '539',                      # U+0x03BF
        'pi' => '601',                           # U+0x03C0
        'rho' => '557',                          # U+0x03C1
        'sigma1' => '445',                       # U+0x03C2
        'sigma' => '572',                        # U+0x03C3
        'tau' => '450',                          # U+0x03C4
        'upsilon' => '541',                      # U+0x03C5
        'phi' => '695',                          # U+0x03C6
        'chi' => '506',                          # U+0x03C7
        'psi' => '730',                          # U+0x03C8
        'omega' => '714',                        # U+0x03C9
        'iotadieresis' => '295',                 # U+0x03CA
        'upsilondieresis' => '541',              # U+0x03CB
        'omicrontonos' => '539',                 # U+0x03CC
        'upsilontonos' => '541',                 # U+0x03CD
        'omegatonos' => '714',                   # U+0x03CE
        ...
        'afii10042' => '1098',                   # U+0x0428
        'afii10043' => '1098',                   # U+0x0429
        'afii10044' => '762',                    # U+0x042A
        'afii10045' => '967',                    # U+0x042B
        'afii10046' => '640',                    # U+0x042C
        'afii10047' => '657',                    # U+0x042D
        'afii10048' => '1065',                   # U+0x042E
        'afii10049' => '696',                    # U+0x042F
        'afii10065' => '503',                    # U+0x0430
        'afii10066' => '540',                    # U+0x0431
        'afii10067' => '518',                    # U+0x0432
        'afii10068' => '439',                    # U+0x0433
        'afii10069' => '559',                    # U+0x0434
        'afii10070' => '483',                    # U+0x0435
        'afii10072' => '787',                    # U+0x0436
        'afii10073' => '473',                    # U+0x0437
        'afii10074' => '612',                    # U+0x0438
        'afii10075' => '612',                    # U+0x0439
        'afii10076' => '551',                    # U+0x043A
        'afii10077' => '581',                    # U+0x043B
        'afii10078' => '715',                    # U+0x043C
        'afii10079' => '608',                    # U+0x043D
        'afii10080' => '539',                    # U+0x043E
        'afii10081' => '601',                    # U+0x043F
        'afii10082' => '571',                    # U+0x0440
        'afii10083' => '454',                    # U+0x0441
        'afii10084' => '470',                    # U+0x0442
        'afii10085' => '492',                    # U+0x0443
        'afii10086' => '752',                    # U+0x0444
        'afii10087' => '504',                    # U+0x0445
        'afii10088' => '602',                    # U+0x0446
        'afii10089' => '572',                    # U+0x0447
        'afii10090' => '863',                    # U+0x0448
        'afii10091' => '864',                    # U+0x0449
        'afii10092' => '577',                    # U+0x044A
        'afii10093' => '757',                    # U+0x044B
        'afii10094' => '497',                    # U+0x044C
        'afii10095' => '486',                    # U+0x044D
        'afii10096' => '789',                    # U+0x044E
        'afii10097' => '547',                    # U+0x044F
        'afii10071' => '483',                    # U+0x0451
        'afii10099' => '570',                    # U+0x0452
        'afii10100' => '439',                    # U+0x0453
        'afii10101' => '486',                    # U+0x0454
        'afii10102' => '432',                    # U+0x0455
        'afii10103' => '292',                    # U+0x0456
        'afii10104' => '292',                    # U+0x0457
        'afii10105' => '291',                    # U+0x0458
        'afii10106' => '773',                    # U+0x0459
        'afii10107' => '797',                    # U+0x045A
        'afii10108' => '582',                    # U+0x045B
        'afii10109' => '551',                    # U+0x045C
        'afii10110' => '492',                    # U+0x045E
        'afii10193' => '603',                    # U+0x045F

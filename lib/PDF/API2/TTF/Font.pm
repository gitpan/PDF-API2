package PDF::API2::TTF::Font;

=head1 NAME

PDF::API2::TTF::Font - Memory representation of a font
...
defaults to L<PDF::API2::TTF::Table>. The current tables which are supported are:
...
L<PDF::API2::TTF::Table> L<PDF::API2::TTF::GDEF> L<PDF::API2::TTF::GPOS> L<PDF::API2::TTF::GSUB> L<PDF::API2::TTF::LTSH>
L<PDF::API2::TTF::OS_2> L<PDF::API2::TTF::PCLT> L<PDF::API2::TTF::Bsln> L<PDF::API2::TTF::Cmap> L<PDF::API2::TTF::Cvt_>
L<PDF::API2::TTF::Fdsc> L<PDF::API2::TTF::Feat> L<PDF::API2::TTF::Fmtx> L<PDF::API2::TTF::Fpgm> L<PDF::API2::TTF::Glyf>
L<PDF::API2::TTF::Hdmx> L<PDF::API2::TTF::Head> L<PDF::API2::TTF::Hhea> L<PDF::API2::TTF::Hmtx> L<PDF::API2::TTF::Kern>
L<PDF::API2::TTF::Loca> L<PDF::API2::TTF::Maxp> L<PDF::API2::TTF::Mort> L<PDF::API2::TTF::Name> L<PDF::API2::TTF::Post>
L<PDF::API2::TTF::Prep> L<PDF::API2::TTF::Prop> L<PDF::API2::TTF::Vhea> L<PDF::API2::TTF::Vmtx> L<PDF::API2::TTF::OldCmap>
L<PDF::API2::TTF::Glyph> L<PDF::API2::TTF::AATKern> L<PDF::API2::TTF::OldMort>
...
# $VERSION = 0.28;    # MJPH      13-MAR-2002     update ttfbuilder, add PDF::API2::TTF::Cmap::ms_enc()
...
# $VERSION = 0.03;    # MJPH       9-MAR-1999     Move to PDF::API2::TTF for CPAN
# $VERSION = 0.02;    # MJPH      12-FEB-1999     Add support for ' nocsum' for DSIGS
# $VERSION = 0.0001;

%tables = (
        'table' => 'PDF::API2::TTF::Table',
        'GDEF' => 'PDF::API2::TTF::GDEF',
        'GPOS' => 'PDF::API2::TTF::GPOS',
        'GSUB' => 'PDF::API2::TTF::GSUB',
        'LTSH' => 'PDF::API2::TTF::LTSH',
        ...
        'PCLT' => 'PDF::API2::TTF::PCLT',
        'bsln' => 'PDF::API2::TTF::Bsln',
        'cmap' => 'PDF::API2::TTF::Cmap',
        'cvt ' => 'PDF::API2::TTF::Cvt_',
        'fdsc' => 'PDF::API2::TTF::Fdsc',
        'feat' => 'PDF::API2::TTF::Feat',
        'fmtx' => 'PDF::API2::TTF::Fmtx',
        'fpgm' => 'PDF::API2::TTF::Fpgm',
        'glyf' => 'PDF::API2::TTF::Glyf',
        'hdmx' => 'PDF::API2::TTF::Hdmx',
        'head' => 'PDF::API2::TTF::Head',
        'hhea' => 'PDF::API2::TTF::Hhea',
        'hmtx' => 'PDF::API2::TTF::Hmtx',
        'kern' => 'PDF::API2::TTF::Kern',
        'loca' => 'PDF::API2::TTF::Loca',
        'maxp' => 'PDF::API2::TTF::Maxp',
        'mort' => 'PDF::API2::TTF::Mort',
        'name' => 'PDF::API2::TTF::Name',
        'post' => 'PDF::API2::TTF::Post',
        'prep' => 'PDF::API2::TTF::Prep',
        'prop' => 'PDF::API2::TTF::Prop',
...
=head2 PDF::API2::TTF::Font->AddTable($tablename, $class)
...
=head2 PDF::API2::TTF::Font->new(%props)
...
=head2 PDF::API2::TTF::Font->open($fname)
...
sub read
{
    ...
    for ($i = 0; $i < $dir_num; $i++)
    {
        ...
        $type = $tables{$name} || 'PDF::API2::TTF::Table';
        $t = $type;
        if ($^O eq "MacOS")
        { $t =~ s/^|::/:/oig; }
        else
...
#        $self->{'head'}{'checkSumAdjustment'} = 0;
    ...
    ($numTables, $sRange, $eSel, $shift) = PDF::API2::TTF::Utils::TTF_bininfo($numTables, 16);
...
the C<PDF::API2::TTF::Font> object.

B<NOTE>, that it is important that you call this method on any
C<PDF::API2::TTF::Font> object when you wish to destruct it and free up its memory.
...
able to do anything else with the C<PDF::API2::TTF::Font> object; it'll have B<no>
internal state whatsoever.

B<Developer note:> As part of the brute-force cleanup done here, this method
will throw a warning message whenever unexpected key values are found within
the C<PDF::API2::TTF::Font> object.  This is done to help ensure that any unexpected
...
The current PDF::API2::TTF::Font::out method does not support the writing of TrueType
Collections.

package PDF::API2::TTF::Loca;

=head1 NAME

PDF::API2::TTF::Loca - the Locations table, which is intimately tied to the glyf table
...
defaults to L<PDF::API2::TTF::Glyph>.
...
Reads the location table creating glyph objects (L<PDF::API2::TTF::Glyph>) for each glyph
...
sub read
{
    ...
    for ($i = 0; $i < $numGlyphs; $i++)
    {
        ...
        $self->{'glyphs'}[$i] = ($self->{'glyphtype'} || "PDF::API2::TTF::Glyph")->new(
                LOC => $last << ($locFmt ? 0 : 1),

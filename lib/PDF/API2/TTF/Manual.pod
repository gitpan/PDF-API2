...
font. This may be achieved by:
    ...
    $f = PDF::API2::TTF::Font->open($filename) || die "Unable to read $filename";
...
internals of glyphs in which case see L<PDF::API2::TTF::Glyph> for more details.
...
for a glyph may be found in L<PDF::API2::TTF::Glyph>. Once we have all the

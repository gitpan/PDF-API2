package PDF::API2::TTF::Mort::Subtable;

=head1 NAME

PDF::API2::TTF::Mort::Subtable
...
require PDF::API2::TTF::Mort::Rearrangement;
require PDF::API2::TTF::Mort::Contextual;
require PDF::API2::TTF::Mort::Ligature;
require PDF::API2::TTF::Mort::Noncontextual;
require PDF::API2::TTF::Mort::Insertion;
...
sub create
{
    ...
    my $subclass;
    if ($type == 0) {
        $subclass = 'PDF::API2::TTF::Mort::Rearrangement';
    }
    elsif ($type == 1) {
        $subclass = 'PDF::API2::TTF::Mort::Contextual';
    }
    elsif ($type == 2) {
        $subclass = 'PDF::API2::TTF::Mort::Ligature';
    }
    elsif ($type == 4) {
        $subclass = 'PDF::API2::TTF::Mort::Noncontextual';
    }
    elsif ($type == 5) {
        $subclass = 'PDF::API2::TTF::Mort::Insertion';
    }

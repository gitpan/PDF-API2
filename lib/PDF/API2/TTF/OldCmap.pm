package PDF::API2::TTF::OldCmap;

=head1 NAME

PDF::API2::TTF::OldCmap - Character map table
...
is the L<PDF::API2::TTF::Segarr> which handles the segmented arrays of format 4 tables,
...
important (although L<PDF::API2::TTF::Segarr> can work quite happily without it).
...
This points to a L<PDF::API2::TTF::Segarr> which contains the content of the particular
subtable.
...
use strict;
use vars qw(@ISA);
require PDF::API2::TTF::Table;
require PDF::API2::TTF::Segarr;

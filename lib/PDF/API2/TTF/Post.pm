package PDF::API2::TTF::Post;

=head1 NAME

PDF::API2::TTF::Post - Holds the Postscript names for each glyph
...
=item $PDF::API2::TTF::Post::no25

If set tells PDF::API2::TTF::Post::out to use table type 2 instead of 2.5 in case apps

...
#
#   $Id: Util.pm,v 1.22 2005/06/17 18:53:33 fredo Exp $
#
#=======================================================================
...
BEGIN {
    ...
    ( $VERSION ) = sprintf '%i.%03i', split(/\./,('$Revision: 1.22 $' =~ /Revision: (\S+)\s/)[0]); # $Date: 2005/06/17 18:53:33 $
...
=head1 HISTORY
    ...
    $Log: Util.pm,v $
    Revision 1.22  2005/06/17 18:53:33  fredo

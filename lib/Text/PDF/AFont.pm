package Text::PDF::AFont;

# $VERSION = "0.499"; # created before Text::PDF::API version 0.5 (final)
$VERSION = "0.5"; # created before PDF::API2 version 0.1.x (beta)
...
Text::PDF::AFont - Embedding of Adobe PFB/PFA + AFM format fonts. Inherits from
L<Text::PDF::Dict>

=head1 METHODS

=head2 Text::PDF::AFont->new $parent, $name, $psfile, $afmfile, $pdfname [ , $encoding [ , @glyphs ]]
...
=head2 Text::PDF::AFont->newNonEmbed $parent, $afmfile, $pdfname [ , $encoding [, @glyphs ]]

Creates a new font object with given parent and name from pfb/pfa from psfile
and afm from afmfile.

All the rules for Text::PDF::AFont->new apply here, but instead of having a embedded font
...
=head2 Text::PDF::AFont->newCore $parent, $fontname, $pdfname [, $encoding [, @glyphs ]]
...
All the rules of Text::PDF::AFont->newNonEmbed apply here, but don't require you to specify an afm-file
